...
%, based on all evaluation runs with the same configuration, which only differ in the specific set of reference edges used, but not in the reference edge sets size.
...
%\midrule
%original 			& - 			& -			& 0.71 (-) & 0.21 (-) & 0.32 (-) \\
%\hline
%semsim-fix 			& cn 		& -			& 0.76 (0.92) & 0.91 (0.00) & 0.50 (0.25) \\
%semsim-fix 			& w2v 		& -			& 0.79 (0.61) & 0.99 (0.00) & \textbf{0.51} (0.27) \\
%\hline
%semsim-fix-lemma 	& cn 		& -			& 0.72 (0.64) & 1.00 (0.00) & \textbf{0.52} (0.30) \\
%semsim-fix-lemma 	& w2v 		& -			& 0.71 (0.60) & 0.99 (0.00) & 0.50 (0.33) \\
%\hline
%semsim-ctx 			& e5 		& r-1-1 		& 1.00 (0.79) & 1.00 (0.00) & 0.51 (0.65) \\
%semsim-ctx 			& e5 		& r-1-2 		& 1.00 (0.84) & 1.00 (0.00) & 0.50 (0.68) \\
%semsim-ctx 			& e5 		& r-1-3 		& 1.00 (0.82) & 1.00 (0.00) & 0.50 (0.67) \\
%semsim-ctx 			& e5 		& r-1-4 		& 1.00 (0.82) & 1.00 (0.00) & 0.52 (0.59) \\
%semsim-ctx 			& e5 		& r-1-mean 	& 1.00 (0.81) & 1.00 (0.00) & \textbf{0.56} (0.67) \\
%\hline
%semsim-ctx 			& e5 		& r-10-1 	& 1.00 (0.86) & 1.00 (0.00) & 0.57 (0.72) \\
%semsim-ctx 			& e5 		& r-10-2 	& 1.00 (0.87) & 1.00 (0.00) & 0.53 (0.71) \\
%semsim-ctx 			& e5 		& r-10-3 	& 1.00 (0.89) & 1.00 (0.00) & 0.57 (0.72) \\
%semsim-ctx 			& e5 		& r-10-4 	& 1.00 (0.85) & 1.00 (0.00) & 0.53 (0.72) \\
%semsim-ctx 			& e5 		& r-10-mean & 1.00 (0.85) & 1.00 (0.00) & \textbf{0.56} (0.71) \\
%\hline
%semsim-ctx 			& e5-at		& r-1-1 		& 1.00 (0.81) & 1.00 (0.00) & 0.49 (0.68) \\
%semsim-ctx 			& e5-at		& r-1-2 		& 1.00 (0.84) & 1.00 (0.00) & 0.51 (0.71) \\
%semsim-ctx 			& e5-at		& r-1-3 		& 1.00 (0.81) & 1.00 (0.00) & 0.50 (0.71) \\
%semsim-ctx 			& e5-at		& r-1-4 		& 1.00 (0.83) & 1.00 (0.00) & 0.51 (0.66) \\
%semsim-ctx 			& e5-at		& r-1-mean 	& 1.00 (0.82) & 1.00 (0.00) & \textbf{0.54} (0.71) \\
%\hline
%semsim-ctx 			& e5-at		& r-10-1 	& 1.00 (0.86) & 1.00 (0.00) & 0.55 (0.75) \\
%semsim-ctx 			& e5-at		& r-10-2 	& 1.00 (0.90) & 1.00 (0.00) & 0.53 (0.75) \\
%semsim-ctx 			& e5-at		& r-10-3 	& 1.00 (0.95) & 1.00 (0.00) & 0.51 (0.74) \\
%semsim-ctx 			& e5-at		& r-10-4 	& 1.00 (0.87) & 1.00 (0.00) & 0.53 (0.74) \\
%semsim-ctx 			& e5-at		& r-10-mean & 1.00 (0.87) & 1.00 (0.00) & \textbf{0.53} (0.74) \\
%\hline
%semsim-ctx 			& gte 		& r-1-1 		& 1.00 (0.81) & 1.00 (0.00) & 0.46 (0.57) \\
%semsim-ctx 			& gte 		& r-1-2 		& 1.00 (0.80) & 1.00 (0.00) & 0.52 (0.63) \\
%semsim-ctx 			& gte 		& r-1-3 		& 1.00 (0.83) & 1.00 (0.00) & 0.48 (0.61) \\
%semsim-ctx 			& gte 		& r-1-4 		& 1.00 (0.79) & 1.00 (0.00) & 0.46 (0.55) \\
%semsim-ctx 			& gte 		& r-1-mean 	& 1.00 (0.76) & 1.00 (0.00) & \textbf{0.49} (0.60) \\
%\hline
%semsim-ctx 			& gte 		& r-10-1 	& 1.00 (0.85) & 1.00 (0.00) & 0.53 (0.67) \\
%semsim-ctx 			& gte 		& r-10-2 	& 1.00 (0.88) & 1.00 (0.00) & 0.52 (0.69) \\
%semsim-ctx 			& gte 		& r-10-3 	& 1.00 (0.85) & 1.00 (0.00) & 0.51 (0.68) \\
%semsim-ctx 			& gte 		& r-10-4 	& 1.00 (0.88) & 1.00 (0.00) & 0.52 (0.67) \\
%semsim-ctx 			& gte 		& r-10-mean & 1.00 (0.83) & 1.00 (0.00) & \textbf{0.53} (0.69) \\
%\hline
%semsim-ctx 			& gte-at 	& r-1-1 		& 1.00 (0.81) & 1.00 (0.00) & 0.48 (0.65) \\
%semsim-ctx 			& gte-at 	& r-1-2 		& 1.00 (0.81) & 1.00 (0.00) & 0.49 (0.66) \\
%semsim-ctx 			& gte-at 	& r-1-3 		& 1.00 (0.82) & 1.00 (0.00) & 0.46 (0.63) \\
%semsim-ctx 			& gte-at 	& r-1-4 		& 1.00 (0.82) & 1.00 (0.00) & 0.47 (0.66) \\
%semsim-ctx 			& gte-at 	& r-1-mean 	& 1.00 (0.83) & 1.00 (0.00) & \textbf{0.52} (0.68) \\
%\hline
%semsim-ctx 			& gte-at 	& r-10-1 	& 1.00 (0.85) & 1.00 (0.00) & 0.50 (0.71) \\
%semsim-ctx 			& gte-at 	& r-10-2 	& 1.00 (0.94) & 1.00 (0.00) & 0.48 (0.70) \\
%semsim-ctx 			& gte-at 	& r-10-3 	& 1.00 (0.91) & 1.00 (0.00) & 0.50 (0.72) \\
%semsim-ctx 			& gte-at 	& r-10-4 	& 1.00 (0.86) & 1.00 (0.00) & 0.51 (0.73) \\
%semsim-ctx 			& gte-at 	& r-10-mean & 1.00 (0.88) & 1.00 (0.00) & \textbf{0.50} (0.72) \\
\bottomrule
\end{tabular}
