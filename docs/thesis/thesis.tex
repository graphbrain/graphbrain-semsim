...
%While not all neural embedding approaches employ neural networks, they generally utilise some form of machine learning. 

%One central commonality here is the scale of the training process -- i.e. the amount of data used for training -- that was enabled by technological advances at the time. 
%This work adheres to this broader understanding of neural embeddings. 
...
%\todo[inline]{Add not that distinctive feature is contextuality, Refer to bag of words}
...
\todo{already refer to massive text embedding benchmark at this point?}
...
%\subsection{Hybrid Measures of Semantic Similarity}
...
-> argue why embedding models (-> caching embeddings / add discussing about effiency?) \\
...
\todo[inline]{adapt this to include the usage of a variable}
...
%(see \cref{sec:CNESS-reference-context}).
...
yada yada see above \todo{extend when chapter 2 is ready}
