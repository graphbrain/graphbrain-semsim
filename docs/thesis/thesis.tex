...
\paragraph{Sampling}
Matching \cref{pat:wildcard-pred} against the Worldnews-SH results in

sampling the dataset from the pattern matching results
--> lemma-based binning


\paragraph{Labeling}
-> 50 edges labeled by everyone, then asses disagreements and refine understanding of conflict. 
